...
<section id="portfolio">
  <div className="row">
    ...
    <div id="modal-02" className="popup-modal mfp-hide">
      ...
      <div className="link-box">
        <a href="https://acoruskovski.edu.mk/">Details</a>
        <a className="popup-modal-dismiss">Close</a>
      </div>
    </div>{/* modal-02 End */}
    <div id="modal-03" className="popup-modal mfp-hide">
      ...
      <div className="link-box">
        <a href="http://dim.edu.mk/">Details</a>
        <a className="popup-modal-dismiss">Close</a>
      </div>
    </div>{/* modal-03 End */}
    <div id="modal-04" className="popup-modal mfp-hide">
      ...
      <div className="description-box">
        ...
        <span className="categories"><i className="fa fa-tag" />SDK</span>
      </div>
      <div className="link-box">
        <a href="https://github.com/inplayer-org/paypal">Details</a>
        <a className="popup-modal-dismiss">Close</a>
      </div>
    </div>{/* modal-04 End */}
